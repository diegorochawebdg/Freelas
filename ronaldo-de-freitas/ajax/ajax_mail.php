<?php
	...
	$mail->Host = "mail.ronaldodefreitas.com.br"; // Endereço do servidor SMTP
	$mail->SMTPAuth = true; // Usa autenticação SMTP? (opcional)							
	$mail->Username = 'contato@ronaldodefreitas.com.br'; // Usuário do servidor SMTP
	...
	$mail->FromName = "Ronaldo de Freitas - Cirurgião Dentista"; // Seu nome
	...
	$mail->Body = "Contato através do site www.ronaldodefreitas.com.br: <br />";
