...
<?php get_header(); ?>
        ...
        $background_image_fix = get_post_meta($post->ID, "page_fix_image", true);
        ...
        if ($page_background_img != '') {
            ...
            if ($background_image_fix == 'on') {
                $background_image_fix = 'background-attachment: fixed';
            } else {
                $background_image_fix = '';
            }
        ...
        if ($page_title != 'no') {
            $div_title = '<div class="page-title">                      
                      <h1 class="page-title" style="color:' . $page_title_color . '">' . get_the_title($post) . '</h1><div class="title-description" style="color:' . $page_title_description_color . '">' . $page_title_description . '</div>
        ...
        if ($first_page == '1') {
            ...
            <?php if (get_option('dry_menu_logo')): ?>
                        ...
                        <a class="left" href="<?php echo(site_url('/')); ?>">
                            <img class="logo" src="<?php echo get_option('dry_menu_logo'); ?>" alt="" />
                        </a>
            <?php endif; ?>
                    <aside class="right">
                    <?php
