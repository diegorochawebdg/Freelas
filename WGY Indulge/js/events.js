...
$(document).ready(function() {
	...
	slider6 = $('#gastronomy-slider .item6 .the-slider ul.slide').bxSlider(settings());
	...
	slider11 = $('#nightlife-slider .item11 .the-slider ul.slide').bxSlider(settings());
	slider12 = $('#nightlife-slider .item12 .the-slider ul.slide').bxSlider(settings());
	slider13 = $('#nightlife-slider .item13 .the-slider ul.slide').bxSlider(settings());
	...
	function resizeSlider2() {
		...
		window.slider11.reloadSlider(settings());
		window.slider12.reloadSlider(settings());
		window.slider13.reloadSlider(settings());
	}
